...
//           const roomTotal =
//             parsedReservation.selectedRooms?.reduce(
//               (sum: number, room: any) => {
//                 return (
//                   sum + room.price * room.quantity * parsedReservation.nights
//                 );
//               },
//               0
//             ) || 0;
...
//           const packageTotal =
//             parsedReservation.selectedPackages?.reduce(
//               (sum: number, pkg: any) => {
...
//           const promoDiscount = parsedReservation.promoCode
//             ? 0.15 * roomTotal
//             : 0;

//           const voucherAmount = parsedReservation.voucherAmount || 0;
...
//             totalPrice: roomTotal + packageTotal - promoDiscount - voucherAmount,
...
//     // Redirect if collect is not "hotelcollect"
//     if (collect?.trim().toLowerCase() !== "hotelcollect") {
...
//     ? roomTypes.find(
//         (room: RoomType) => room.id === bookingDetails.selectedRoomId
//       )
//     : undefined;
...
//           (plan: MealPlan) => plan.id === bookingDetails.mealPlanId
//         )
//       : undefined;
...
//       ? countries.find(
//           (country: Country) => country.code === bookingDetails.nationality
//         )?.name || "Not specified"
//       : "Not specified";
//   // Helper to map RoomType to Room (fill with defaults if needed)
//   const mapRoomTypeToRoom = (
...
//             // Handle Next.js <Image> wrappers by ensuring correct src
//             const dataSrc = img.getAttribute("data-nimg") ? img.getAttribute("src") : null;
//             if (dataSrc) {
...
//       link.href = imgData;
//       link.download = `booking-${bookingDetails.bookingId}.png`;
...
//           ? format(bookingDetails.checkIn, "MMMM d, yyyy")
//           : ""
//       }
//       Check-out: ${
//         bookingDetails.checkOut
//           ? format(bookingDetails.checkOut, "MMMM d, yyyy")
//           : ""
//       }
...
//                       {formatPrice(
//                         convertPrice(
//                           bookingDetails.selectedRooms.reduce(
...
//                       </ul>
//                       {(() => {
//                         const totalPackageCost = bookingDetails.selectedPackages.reduce(
//                           (sum: number, pkg: any) => sum + pkg.Price,
//                           0
//                         );
//                         return totalPackageCost > 0 ? (
//                           <div className="flex justify-between">
//                             <span className="text-sm text-muted-foreground">
//                               Total Package Cost
//                             </span>
//                             <span className="text-sm font-medium text-foreground">
//                               {formatPrice(convertPrice(totalPackageCost))}
//                             </span>
//                           </div>
//                         ) : null;
//                       })()}
...
//                     </>
//                   )}
//                   {bookingDetails.voucherAmount > 0 && (
//                     <>
//                       <div className="text-sm font-semibold text-foreground mt-4 mb-2">
//                         Voucher
//                       </div>
//                       <div className="flex justify-between mb-2 text-green-700">
//                         <span className="text-sm font-medium">Voucher Discount</span>
//                         <span className="text-sm font-medium">
//                           -{formatPrice(convertPrice(bookingDetails.voucherAmount))}
//                         </span>
//                       </div>
//                     </>
//                   )}
...
//                   <div className="flex justify-between">
//                     <span>
//                       {paymentCollect?.trim().toLowerCase() === "arrival" || paymentCollect?.trim().toLowerCase() === "hotelcollect"
//                         ? "Amount Due"
//                         : "Total"}
//                     </span>
//                     <span>
//                       {formatPrice(
//                         convertPrice(
//                           bookingDetails.totalPrice ?? bookingDetails.total ?? 0
//                         )
//                       )}
//                     </span>
//                   </div>
...
//           {hotelDetails?.Email && <p>Email: {hotelDetails.Email}</p>}
//           <br></br>
//         </div>
//       </Card>
...
//         <Button asChild size="lg" className="btn-dynamic">
