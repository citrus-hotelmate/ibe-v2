...
export function SearchBar({ onSearch }: SearchBarProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl flex flex-col sm:flex-row sm:items-center border border-white/30 overflow-visible relative z-10 gap-2 sm:gap-0 p-2 sm:p-0">
      {/* City or Destination */}
      <div className="w-full sm:flex-1 px-2 sm:px-3 py-2 relative" ref={destinationRef}>
        ...
        {showDestinationSuggestions && (
          <div
  className="absolute z-[110] mt-3 bg-white border border-gray-300 rounded-xl 
             shadow-lg max-h-80 overflow-auto left-0 right-0 
             w-full min-w-[18rem] p-3 space-y-3">
            {/* Recent Searches */}
